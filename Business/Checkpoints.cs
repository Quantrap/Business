...
namespace Business
{
    public partial class Checkpoints : Form
    {
        ...
        public Checkpoints(int num)
        {
            ...
            Form f = Application.OpenForms["Map"];
        ...
        private void Checkpoints_Load(object sender, EventArgs e)
        {
            ...
            logos[0].Image = Image.FromFile("D:\\Business\\Business\\images\\map-icons\\map-icon-drinks.png");
            logos[0].Width = 40;
            logos[0].Height = 40;
            logos[0].SizeMode = PictureBoxSizeMode.Zoom;

            logos[1].Image = Image.FromFile("D:\\Business\\Business\\images\\map-icons\\map-icon-energy-bars.png");
            logos[1].Width = 40;
            logos[1].Height = 40;
            logos[1].SizeMode = PictureBoxSizeMode.Zoom;

            logos[2].Image = Image.FromFile("D:\\Business\\Business\\images\\map-icons\\map-icon-toilets.png");
            logos[2].Width = 40;
            logos[2].Height = 40;
            logos[2].SizeMode = PictureBoxSizeMode.Zoom;

            logos[3].Image = Image.FromFile("D:\\Business\\Business\\images\\map-icons\\map-icon-information.png");
            logos[3].Width = 40;
            logos[3].Height = 40;
            logos[3].SizeMode = PictureBoxSizeMode.Zoom;

            logos[4].Image = Image.FromFile("D:\\Business\\Business\\images\\map-icons\\map-icon-medical.png");
            logos[4].Width = 40;
            logos[4].Height = 40;
